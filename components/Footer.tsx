        ...
        <div className="grid grid-cols-1 gap-10 text-left md:grid-cols-3">
          ...
          <div className="flex flex-col items-start">
            <Link href="/" className="flex items-center gap-3">
             <img src="/images/logo-campurejo.png"
                alt="CAMPSS Logo"
                className="h-11 w-11 object-contain"
              />
              <span className="text-2xl font-black tracking-wide text-[#063d2b]">
                CAMPSS
              </span>
            </Link>
          ...
          {/* INFORMASI */}
          <div className="flex flex-col items-start">
            <h4 className="mb-4 text-base font-bold uppercase tracking-wider text-[#063d2b]">
              Informasi
            </h4>
            <ul className="flex flex-col items-start gap-3 text-sm text-gray-600">
              <li>
                <Link href="/jalur" className="transition-colors hover:text-[#17634a]">
                  Jalur Pendakian
                </Link>
              </li>
              <li>
                <Link href="/cek-kuota" className="transition-colors hover:text-[#17634a]">
                  Cek Kuota Pendakian
                </Link>
              </li>
              <li>
                <Link href="/vegetasi" className="transition-colors hover:text-[#17634a]">
                  Info Vegetasi & Flora
                </Link>
              </li>
              <li>
                <Link href="/panduan" className="transition-colors hover:text-[#17634a]">
                  Panduan & SOP
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="mb-5 flex flex-col items-start gap-3 text-sm text-gray-600">
              <li className="flex items-center gap-2">
                <svg className="h-5 w-5 shrink-0 text-[#063d2b]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                  <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
                  <circle cx="12" cy="10" r="3" />
                </svg>
                <span className="leading-relaxed">Basecamp Prau via Campurejo</span>
              </li>
              
              <li className="flex items-center gap-2">
                <svg className="h-5 w-5 shrink-0 text-[#063d2b]" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/prau_via_campurejo"
              target="_blank"
